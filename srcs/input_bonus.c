...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/23 17:12:11 by seunghoy          #+#    #+#             */
/*   Updated: 2023/02/23 17:12:13 by seunghoy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_frac_argu_bonus(char ***in_arr_p)
{
	...
	if (in == (char *)1)
	{
		...
		exit(print_possible_input_bonus());
	else
	{
		erase_nl(in);
